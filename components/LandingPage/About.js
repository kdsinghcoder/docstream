    ...
    return (
        <section id="About" class="text-gray-400 bg-gray-900 body-font">
            <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                <div data-aos="fade-up" class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 md:mb-0 mb-10">
                    <img class="object-cover object-center rounded" alt="hero" src="https://i.imgur.com/wcfLGZM.png" />
                </div>
                <div  class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                    <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">About Docstream
                        <br class="hidden lg:inline-block" />
                    </h1>
                    <p  class="mb-8 leading-relaxed">Docstream empowers you to start making your content right away without having to worry about any registeration process <br/>
