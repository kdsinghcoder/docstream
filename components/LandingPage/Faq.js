function Faq() {
    ...
    return (
        ...
        <section id="Faq" class="text-gray-700 bg-gray-900">
                ...
                <div class="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
                    ...
                    <div class="w-full lg:w-1/2 px-4 py-2 ">
                        <details class="mb-4">
                            ...
                            <summary class="font-semibold  bg-transprent text-lg text-white rounded-md py-2 px-4 bg-green-500">
                        ...
                        <details class="mb-4">
                            ...
                            {/* <summary class="font-semibold  bg-transprent text-lg text-white rounded-md py-2 px-4 bg-white-500"> */}
